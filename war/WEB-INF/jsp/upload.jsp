					...
					<div class="startEvent">
						...
						<table class="form">
							<tbody>
								<tr>
									<th>Name:</th>
									<td><span class="name">Event's Name</span></td>
								</tr>
						...
						<div class="task">
							<table>
								<tbody>
									<tr>
										<th>Name:</th>
										<td><span class="name">Task name</span>
										</td>
									</tr>
									<tr>
										<th>Task id:</th>
										<td><span class="id">id</span>
										</td>
									</tr>
									<tr>
										<th>Resource:</th>
									...
									<tr>
										<th>Fixed cost:</th>
										<td><input class="fixedCost" name="fixedCost" />
										</td>
									</tr>
									<tr>
										<th>Type</th>
						...
						<div class="gateway">
							<table>
								<tbody>
									<tr>
										<th>Name:</th>
										<td><span class="name">Gateway name/target name?</span>
										</td>
									</tr>
									<tr>
										<th>Type:</th>
										<td><span class="type">Type</span>
										</td>
									</tr>
									<tr>
										<th>Id:</th>
									...
									<tr>
										<th>SourceRef</th>
										<td><span class="sourceRef">SourceRef</span>
										</td>
									</tr>
									<tr>
										<th>TargetRef</th>
										<td><span class="targetRef">TargetRef</span>
										</td>
									</tr>
									<tr>
